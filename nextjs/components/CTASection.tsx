...
export default function CTASection() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-primary text-light fade-in">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-secondary text-primary px-8 py-4 font-semibold text-lg hover:bg-secondary/90 transition-colors transition-transform hover:-translate-y-0.5"
        >
