                ...
                {currentLang === 'vi' ? (
                  <>
                    <tr>
                      ...
                      <td className="p-3 border border-espresso/10">Khảo sát thị trường & nguyên liệu địa phương.</td>
                    </tr>
                    <tr className="bg-warmwhite/50">
                      <td className="p-3 border border-espresso/10">2</td>
                      <td className="p-3 border border-espresso/10">Chọn module ưu tiên: Bánh mì / Phở / Món truyền thống.</td>
                    </tr>
                    <tr>
                      <td className="p-3 border border-espresso/10">3</td>
                      <td className="p-3 border border-espresso/10">Chuẩn hóa công thức + SOP sản xuất & phục vụ.</td>
                    </tr>
                    <tr className="bg-warmwhite/50">
                      <td className="p-3 border border-espresso/10">4</td>
                      <td className="p-3 border border-espresso/10">Thử nghiệm bán nhỏ, đo lường, điều chỉnh.</td>
                    </tr>
                    <tr>
                      <td className="p-3 border border-espresso/10">5</td>
                      <td className="p-3 border border-espresso/10">Chuẩn bị scale‑up: thiết bị, nhân sự, supply.</td>
                    </tr>
                  </>
                ) : (
                  <>
                    <tr>
                      <td className="p-3 border border-espresso/10">1</td>
                      <td className="p-3 border border-espresso/10">Survey market & local ingredients.</td>
                    </tr>
                    <tr className="bg-warmwhite/50">
                      <td className="p-3 border border-espresso/10">2</td>
                      <td className="p-3 border border-espresso/10">Choose priority module: Banh Mi / Pho / Traditional dishes.</td>
                    </tr>
                    <tr>
                      <td className="p-3 border border-espresso/10">3</td>
                      <td className="p-3 border border-espresso/10">Standardize formula + production & service SOP.</td>
                    </tr>
                    <tr className="bg-warmwhite/50">
                      <td className="p-3 border border-espresso/10">4</td>
                      <td className="p-3 border border-espresso/10">Test small sales, measure, adjust.</td>
                    </tr>
                    <tr>
                      <td className="p-3 border border-espresso/10">5</td>
                      <td className="p-3 border border-espresso/10">Prepare for scale‑up: equipment, staff, supply.</td>
                    </tr>
                  </>
                )}
              </tbody>
